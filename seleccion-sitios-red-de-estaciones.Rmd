...
Tras sumar los criterios ponderados, obtuvimos la distribución de las categorías agregadas. En cuanto a superficie representada, predominaron los intermedios, "marginalmente idóneo" y "moderadamente idóneo" con un 70% de toda la superficie estudiada, mientras que las categorías extremas "no idóneo" y "altamente idóneo" se repartieron el restante 30% (ver table \@ref(tab:areasproporcionalesall)).

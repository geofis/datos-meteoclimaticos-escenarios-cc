...
La función de creación de puntos basados en vecindad

```{r}
estacion_cada_250_ai_mi <- generar_centroides_distantes(
  geom = all_criteria_scores_excluded %>%
    filter(`Categoría agregada` %in% c('altamente idóneo', 'moderadamente idóneo')),
  km2_por_puntos = 250)
estacion_cada_250_ai_mi %>% 

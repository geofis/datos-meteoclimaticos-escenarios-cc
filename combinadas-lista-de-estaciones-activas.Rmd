...
De las instituciones listadas abajo, aunque recibimos documentación sobre estaciones (históricas y/o actuales), o sostuvimos reuniones de intercambio de información, no recibimos coordenadas.
...
Las razones ofrecidas por las entidades para no compartir coordenadas de estaciones fueron diversas, desde cuestiones relacionadas con confidencialidad, hasta pérdida de archivo digital o dificultad para localizarlo.
...
Mapa de estaciones climáticas de la red pública según estado

```{r, fig.width=15.7, fig.height=10.5, dpi=62}
fpal_estado <- colorFactor(
  palette = c("#E41A1C", "#FFFF33","#40ff40"),
  domain = unique(consolidado_sf$Estado), reverse = T)
leaflet(consolidado_sf %>% filter(tipo == 'meteoclimática', propiedad == 'pública')) %>%
  addCircleMarkers(
    radius = 5, group = ~ Estado,
    popup = ~ paste0('Entidad: ', entidad, '<br>Nombre: ', Nombre, '<br>Estado: ', Estado),
    color = ~ fpal_estado(Estado),
...
```{r}
save.image('r-image-ws-list.RData')
sessionInfo()
...
#  [1] janitor_2.2.0        fuzzyjoin_0.1.6      kableExtra_1.3.4     lubridate_1.9.3     
#  [5] forcats_1.0.0        stringr_1.5.0        dplyr_1.1.4          purrr_1.0.1         
#  [9] readr_2.1.4          tidyr_1.3.0          tibble_3.2.1         ggplot2_3.5.1       
# [13] tidyverse_2.0.0      parzer_0.4.1         readxl_1.4.2         readODS_1.8.0       
# [17] mapview_2.11.0       leaflet.extras_1.0.0 leaflet_2.1.2        sf_1.0-12           
# 
# loaded via a namespace (and not attached):
#  [1] tidyselect_1.2.0        viridisLite_0.4.2       farver_2.1.1            fastmap_1.1.1          
#  [5] digest_0.6.31           timechange_0.2.0        lifecycle_1.0.3         ellipsis_0.3.2         
#  [9] ggspatial_1.1.8         terra_1.7-78            magrittr_2.0.3          compiler_4.3.0         
# [13] rlang_1.1.4             sass_0.4.6              tools_4.3.0             yaml_2.3.7             
# [17] utf8_1.2.3              knitr_1.42              htmlwidgets_1.6.2       bit_4.0.5              
# [21] sp_2.1-4                classInt_0.4-9          xml2_1.3.4              RColorBrewer_1.1-3     
# [25] KernSmooth_2.23-20      withr_2.5.0             grid_4.3.0              stats4_4.3.0           
# [29] fansi_1.0.4             e1071_1.7-13            leafem_0.2.0            colorspace_2.1-0       
# [33] scales_1.3.0            cli_3.6.1               crayon_1.5.2            rmarkdown_2.21         
# [37] generics_0.1.3          rstudioapi_0.14         httr_1.4.6              tzdb_0.4.0             
# [41] DBI_1.1.3               cachem_1.0.8            proxy_0.4-27            parallel_4.3.0         
# [45] rvest_1.0.3             cellranger_1.1.0        base64enc_0.1-3         vctrs_0.6.5            
# [49] webshot_0.5.4           jsonlite_1.8.4          hms_1.1.3               bit64_4.0.5            
# [53] systemfonts_1.0.4       crosstalk_1.2.0         jquerylib_0.1.4         units_0.8-2            
# [57] glue_1.6.2              leaflet.providers_1.9.0 codetools_0.2-18        stringi_1.7.12         
# [61] gtable_0.3.5            raster_3.6-26           munsell_0.5.0           pillar_1.9.0           
# [65] htmltools_0.5.5         satellite_1.0.4         R6_2.5.1                vroom_1.6.3            
# [69] evaluate_0.21           lattice_0.20-45         highr_0.10              png_0.1-8              
# [73] snakecase_0.11.0        bslib_0.4.2             class_7.3-20            Rcpp_1.0.10            
# [77] svglite_2.1.1           xfun_0.39               pkgconfig_2.0.3    
```

...
```
    ...
    ## 
    ##    indrhi_historico indrhi_telemetricas               intec              reddom 
    ##                 121                  78                   5                  32

## Mapa

``` r
fpal <- colorFactor(RColorBrewer::brewer.pal(4, 'Set1'), domain = unique(consolidado_estaciones_sf$fuente))
leaflet(consolidado_estaciones_sf) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = ~ fuente,
    options = layersControlOptions(collapsed = FALSE))
```

![](consolidacion-lista-estaciones_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

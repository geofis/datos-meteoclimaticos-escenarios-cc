---
title: "Consolidación inicial de listas de estaciones"
...
```{r mapa, echo=F, fig.width=12.7, fig.height=10.5, dpi=62}
fpal <- colorFactor(
...
fpal_condiciones <- colorFactor(
  ...
  domain = unique(afd_indrhi_telem_sf$CONDICIONES), reverse = T)
...
`r if(knitr::opts_knit$get("rmarkdown.pandoc.to") == 'gfm-yaml_metadata_block') 'Versión interactiva del mapa, [aquí](https://geofis.github.io/datos-meteoclimaticos-escenarios-cc/consolidacion-lista-estaciones.html#mapa-de-estaciones-climáticas-convencionales-onamet-estudio-afd)'`

`r if(knitr::opts_knit$get("rmarkdown.pandoc.to") == 'latex') 'Versión interactiva del mapa, [aquí](https://geofis.github.io/datos-meteoclimaticos-escenarios-cc/consolidacion-lista-estaciones.html#mapa-de-estaciones-climáticas-convencionales-onamet-estudio-afd)'`

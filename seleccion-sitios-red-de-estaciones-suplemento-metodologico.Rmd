...
Aplicamos la función definiendo dos escenarios posibles, en los que cada estación cubre 100 y 250 kilómetros cuadrados, respectivamente.
...
Si comparamos con la red de estaciones activas de ONAMET, obtenemos que la distancia de separación entre estaciones activas para el primer orden de vecindad, es superior a la propuesta en cualquiera de los dos escenarios. Además, hay al menos dos estaciones de la red de ONAMET que se encuentran separadas hasta a 48 km.
...
Eliminamos las propuestas de sitios del escenario a 100 $km^2$ por estación, situadas a 11 km o menos de estaciones preexistentes de ONAMET e INDRHI.
...
Repetimos los mismos pasos para el escenario de una estación por cada 250 $km^2$.

...
En el caso del escenario "100 km<sup>2</sup> por estación", la distancia de corte entre estaciones es de 11 km. Por lo tanto, eliminaremos las estaciones propuestas por nosotros que queden dentro de ese rango respecto de estaciones de ONAMET y/o INDRHI existentes.

Usamo igualmente las estaciones de la red privada, pero sólo para fines de representación. Nuestro objetivo, al mostrar la red privada sobre los escenarios de densidad, es visibilizar las oportunidad de colaboración y la posible sinergia que contribuirían en definitiva a la mejora de la calidad del dato.

...
```{r fondosdevalle, echo=F, fig.cap='Índice múltiresolución de planitud de fondos de valle (MrVBF)'}
knitr::include_graphics("out/fondos-de-valle.jpg")
```
...
Genemos las prioridades reescaladas por cada escenario de densidad, usando la función `v.overlay`.
...
Mostramos las prioridades reescaladas para cada escenario de densidad, en los mapas a continuación. Los autores de esta investigación somos conscientes de que hay que eliminar determinados tramos, en concreto, en áreas de karst y/o de riego. Pudimos haberlo hecho manualmente, pero no es una opción metodológicamente correcta, ni reproducible, así que lo mejoraremos en breve y esta nota desaparecerá. No obstante, la aproximación automática ofrece una priorización bastante ajustada a la realidad territorial dominicana.

```{r prioridadesc100km2, echo=F, fig.cap='Prioridad de instalación de estaciones hidrométricas, escenario de densidad, 100 km cuadrados.'}
knitr::include_graphics("out/tramos-prioritarios-densidad-100.jpg")
```

```{r prioridadesc150km2, echo=F, fig.cap='Prioridad de instalación de estaciones hidrométricas, escenario de densidad, 150 km cuadrados.'}
knitr::include_graphics("out/tramos-prioritarios-densidad-150.jpg")
```

```{r prioridadesc250km2, echo=F, fig.cap='Prioridad de instalación de estaciones hidrométricas, escenario de densidad, 250 km cuadrados.'}
...
Número de áreas de prospección en las que se propone instrumentar. Cabe señalar que, **en varias unidades de prospección, existen múltiples tramos posibles donde resulta viable instalar estaciones hidrométricas**. En tales casos, recomendamos evaluar la mejor opción, para lo cual el criterio técnico y el conocimiento de terreno serían bastante oportunos.

...
Aunque no existe un criterio estricto de separación entre EMC

Las EMC suelen colocarse a una distancia "óptima" entre sí, a efectos de garantizar mediciones precisas y representativas de las condiciones climáticas locales. La distancia entre las estaciones meteorológicas depende de varios factores, como el tamaño del área de estudio, el tipo de clima en la región y las variables climáticas específicas que se están midiendo. En general, lo que se intenta garantizar es la precisión y la representatividad, evitando al mismo tiempo la redundancia [@design1976hydrological].

A tal efecto, para implementar estos criterios, escribimos varias funciones para proponer alternativas óptimas de redes de EMC. Utilizando principalmente análisis de vecindad, dichas funciones toman en cuenta tanto las localizaciones de las estaciones existentes como las de las propuestas, seleccionan una red con separación óptima entre estaciones, maximizan los criterios precisión y representatividad, y se apegan a los estándares sugeridos por la OMM [@design1976hydrological].
